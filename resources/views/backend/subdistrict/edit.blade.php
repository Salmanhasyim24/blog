                            ...
                            <div class="card-body">
                                ...
                                <form id="myForm" method="post"
                                            ...
                                            <select name="district_id" class="form-select" id="js-example-basic-single">
                                                ...
                                                @foreach ($districts as $district)
                                                    <option value="{{ $district->id }}"
                                                        {{ $district->id == $subdistrict->district_id ? 'selected' : '' }}>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="subdistrict_en"
                                                value="{{ $subdistrict->subdistrict_en }}" class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="subdistrict_idn"
                                                value="{{ $subdistrict->subdistrict_idn }}" class="form-control" />
                                        </div>
                                    </div>
